            ...
            <div className="flex flex-col items-center justify-center px-2">
                ...
                <div className="bg-[#2a2a2c] rounded-2xl p-5 text-left font-roboto-mono w-full max-w-sm">
                    ...
                    <div className="flex justify-center items-center space-x-6 mt-6">
                      <a href="https://github.com/USERID" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors" aria-label="GitHub">
                        <Icons.Github className="w-6 h-6" />
                      </a>
                      <a href="mailto:USERID" className="text-zinc-400 hover:text-white transition-colors" aria-label="Email">
                        <Icons.Mail className="w-6 h-6" />
                      </a>
                      <a href="https://instagram.com/USERID" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors" aria-label="Instagram">
